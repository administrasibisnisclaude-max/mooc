...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $course1 = Course::create([
            ...
            'description' => 'Pelajari framework PHP terpopuler, Laravel 10, dari dasar hingga mahir.',
            'tutor_id' => $tutor->id,
        ...
        $course2 = Course::create([
            ...
            'description' => 'Kuasai Python untuk analisis data, visualisasi, dan machine learning.',
            'tutor_id' => $tutor2->id,
        ...
        $course3 = Course::create([
            ...
            'description' => 'Pelajari dasar-dasar web development dengan HTML dan CSS secara gratis.',
            'tutor_id' => $tutor->id,
            'category_id' => $createdCategories[0]->id,
            'price' => 0,
            'level' => 'beginner',
        ...
        Enrollment::create(['user_id' => $student->id, 'course_id' => $course1->id, 'enrolled_at' => now()->subDays(10), 'progress_percentage' => 33]);
        Enrollment::create(['user_id' => $student->id, 'course_id' => $course3->id, 'enrolled_at' => now()->subDays(5), 'progress_percentage' => 100, 'completed_at' => now()->subDays(1)]);

        \App\Models\Certificate::create(['user_id' => $student->id, 'course_id' => $course3->id, 'certificate_number' => 'CERT-' . strtoupper(uniqid()), 'issued_at' => now()->subDays(1)]);

        \App\Models\CourseReview::create(['user_id' => $student->id, 'course_id' => $course1->id, 'rating' => 5, 'review' => 'Kursus yang sangat bagus! Penjelasannya mudah dipahami.']);
        \App\Models\CourseReview::create(['user_id' => $student->id, 'course_id' => $course3->id, 'rating' => 4, 'review' => 'Materi lengkap dan terstruktur dengan baik.']);

        $thread = \App\Models\ForumThread::create(['course_id' => $course1->id, 'user_id' => $student->id, 'title' => 'Cara debug error 500 di Laravel?', 'content' => 'Halo, saya mengalami error 500 ketika menjalankan aplikasi. Bagaimana cara debugnya?']);
        \App\Models\ForumReply::create(['thread_id' => $thread->id, 'user_id' => $tutor->id, 'content' => 'Error 500 biasanya karena kesalahan kode PHP. Cek file log di storage/logs/laravel.log untuk detail errornya.', 'is_answer' => true]);

        \App\Models\Announcement::create(['course_id' => $course1->id, 'tutor_id' => $tutor->id, 'title' => 'Update Materi Terbaru', 'content' => 'Kami telah menambahkan modul baru tentang Laravel Livewire. Silakan cek konten terbaru!']);

        $quiz = \App\Models\Quiz::create(['course_id' => $course1->id, 'section_id' => $section1->id, 'title' => 'Quiz Pengenalan Laravel', 'description' => 'Uji pemahaman Anda tentang dasar-dasar Laravel.', 'passing_score' => 70, 'time_limit' => 15]);
        ...
        \App\Models\Assignment::create(['course_id' => $course1->id, 'section_id' => $section2->id, 'title' => 'Buat Aplikasi CRUD Sederhana', 'description' => "Buat aplikasi CRUD menggunakan Laravel dengan ketentuan:\n1. Tabel produk dengan field: nama, harga, stok\n2. Halaman index menampilkan semua produk\n3. Form tambah dan edit produk\n4. Fungsi hapus dengan konfirmasi", 'due_date' => now()->addDays(14), 'max_score' => 100, 'file_requirements' => 'Upload file ZIP berisi project Laravel Anda. Maks 50MB.']);
    }
}
